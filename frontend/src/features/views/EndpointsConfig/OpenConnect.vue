...
import { createOpenConnectFormEntry, createOpenConnectTnccCert } from '@defaults/endpoints'
import {
...
import type { EndpointOpenConnect } from '@profiles/endpoints'
import PortInput from '@views/Shared/PortInput.vue'
import { useI18n } from 'vue-i18n'

const model = defineModel<EndpointOpenConnect['config']>({ required: true })
const { t } = useI18n()
