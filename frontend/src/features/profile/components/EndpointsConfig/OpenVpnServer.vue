...
import { createOpenVpnUser, createOpenVpnPushDnsServer } from '@profile/defaults/endpoints'
import type { OpenVpnServerEndpoint } from '@profile/types/profiles/endpoints'
