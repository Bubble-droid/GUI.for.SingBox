...
export const LogLevelOptions = defineOptions(
  LogLevel,
  'kernel.log.level.{{val}}',
);
...
export const HttpEngineOptions = defineOptions(
  HttpEngine,
  'kernel.http_clients.engine.{{val}}',
);
...
export const NetnsTypeOptions = defineOptions(
  NetnsType,
  'kernel.netns.type.{{val}}',
);

export const EndpointOptions = defineOptions(
  EndpointType,
  'kernel.endpoints.type.{{val}}',
);

export const InboundOptions = defineOptions(InboundType, '{{val}}');

export const OutboundOptions = defineOptions(
  OutboundType,
  'kernel.outbounds.{{val}}',
);

export const TunStackOptions = defineOptions(
  TunStack,
  'kernel.inbounds.tun.{{val}}',
);
...
export const RuleSetTypeOptions = defineOptions(
  RuleSetType,
  'kernel.route.rule_set.type.{{val}}',
);
...
export const DnsRuleTypeOptions = defineOptions(
  DnsRuleType,
  'kernel.rules.type.{{val}}',
);

export const DnsServerTypeOptions = defineOptions(
  DnsServerType,
  'kernel.dns.type.{{val}}',
);
...
export const NetworkTypeOptions = defineOptions(
  NetworkType,
  'kernel.shared.network_type.{{val}}',
);
...
export const TlsEngineOptions = defineOptions(
  TlsEngine,
  'kernel.shared.tls.engine.{{val}}',
);
...
export const TlsCurvePreferenceOptions = defineOptions(
  TlsCurvePreference,
  '{{val}}',
);
