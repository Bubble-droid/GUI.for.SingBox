...
import type {
  ...
  DnsActionOf,
  DnsServer,
} from '@profile/types/sing-box/dns';
import type {
  RuleSetOf,
  RouteDefaultRule,
  RuleSet,
...
export const AcmeKeyType = {
  ...
  CertificateProviderOf<typeof CertProviderType.Acme>['key_type']
>;
...
export const CloudflareValidity = {
  ...
  CertificateProviderOf<
    typeof CertProviderType.Cloudflare
  >['requested_validity']
>;
...
export const AcmeProvider = {
  ...
  CertificateProviderOf<typeof CertProviderType.Acme>['provider']
>;
...
export const DomainStrategy = {
  ...
  Extract<DomainResolverOptions, object>['strategy']
>;
...
export const CommonActionKind = {
  ...
  Extract<RouteAction['action'], DnsAction['action']>
>;
...
export type OpenConnectCompressionMode = ValueOf<
  typeof OpenConnectCompressionMode
>;
...
export const UtlsFingerprint = {
  ...
  NonNullable<OutboundTlsOptions['utls']>['fingerprint']
>;
