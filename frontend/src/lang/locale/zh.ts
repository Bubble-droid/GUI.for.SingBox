export default {
  ...
  kernel: {
    ...
    route: {
      ...
      final: '默认出站标签',
      default_http_client: '远程规则集使用的默认 HTTP 客户端',
    ...
    rules: {
      type: {
        ...
        ip_version: 'IP版本(ip_version)',
        query_type: 'DNS查询类型(query_type)',
        query_dnssec: 'DNSSEC查询(query_dnssec)',
        query_client_subnet: '查询客户端子网(query_client_subnet)',
        response_rcode: '响应码(response_rcode)',
        response_answer: '响应应答记录(response_answer)',
        response_ns: '响应名称服务器记录(response_ns)',
        response_extra: '响应附加记录(response_extra)',
        inline: '内联(Inline)',
      },
    },
    strategy: {
